class Game {
  ...
  void mousePressed(MouseEvent event) {
    if (screenHandler.currentScreen instanceof InitScreen && mouseButton == LEFT) {
      screenHandler.updater.accept(1);
    }else if (screenHandler.currentScreen instanceof InitScreen && mouseButton == RIGHT) {
      screenHandler.updater.accept(4);
    }
    else if (screenHandler.currentScreen instanceof Help) {
      screenHandler.updater.accept(0);
    } 
